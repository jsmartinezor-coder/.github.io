  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glass-strong": "0 8px 32px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.15)",
        "glass-hover": "0 12px 40px rgba(0, 0, 0, 0.3)",
        glow: "0 0 20px rgba(244, 63, 94, 0.3), 0 0 40px rgba(244, 63, 94, 0.15)",
        "glow-strong": "0 6px 24px rgba(244, 63, 94, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
